...
var support_eventsource = 0; // EventSource(SSE)が利用可能:0, 非サポート:1
...
// ----- 初期処理 -----
console.log('%cＢｅちゃっとぉ%c Ver.0.8.22 20200509', 'color: #BBB; font-size: 2em; font-weight: bold;', 'color: #00a0e9;');
